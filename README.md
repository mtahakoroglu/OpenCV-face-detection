...
<img src="result/haar_cascade_face_detection_frame_1655.jpg" alt="Haar Cascade ile web cam üzerinde yüz tespiti" width="400" height=auto>
...
cv2.waitKey(0)
# save image
cv2.imwrite(f"{imgName}_merged_horizontally.jpg", img, [cv2.IMWRITE_JPEG_QUALITY, 50])
```

<img src="result/webcam_HC_DL.jpg" alt="web cam face detection methods results side by side" width="800" height=auto>
